...
Antes de cualquier promoción deberá reevaluarse contra el `main` vigente, el external derived record reconciliado, `SECURITY.md`, Blueprint, Constituciones, Architecture Quality Gates y las fronteras cognitivas realmente implementadas en ese momento.
