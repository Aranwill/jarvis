...
|------|--------|--------|--------|---------|
| ADR-001 | Accepted | 2026-07-05 | Identity Migration: Jarvis → Malāk | Identity |
| ADR-002 | Accepted | 2026-07-26 | Frontera de enforcement entre PDP y operación protegida | Security |
